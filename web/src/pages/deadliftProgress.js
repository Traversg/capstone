 ...
 */
class DeadliftProgress extends BindingClass {
    constructor() {
        super();
 ...
 */
const main = async () => {
    const deadliftProgress = new DeadliftProgress();
    deadliftProgress.mount();
};
