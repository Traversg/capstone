...
/**
 * Logic needed for the overhead press progress page of the website.
 */
class OverheadPressProgress extends BindingClass {
    constructor() {
        super();
    ...
    /**
     * Method to display overhead press progress.
     */
    displayProgress() {
 ...
 */
const main = async () => {
    const overheadPressProgress = new OverheadPressProgress();
    overheadPressProgress.mount();
};
