...
/**
 * Logic needed for the squat progress page of the website.
 */
class SquatProgress extends BindingClass {
    constructor() {
        super();
    ...
    displayProgress() {
        ...
        for (let workout of workoutHistory) {
            ...
            const weight = workout.squatWeight;
 ...
 */
const main = async () => {
    const squatProgress = new SquatProgress();
    squatProgress.mount();
};
